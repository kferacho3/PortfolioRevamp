...
const state = {
  ...
  paragraphs: [
    ...
    //  "Using the buttons below the floating monitor,, you can browse through previews of websites I've independently developed in the past few years. Clicking on the screen will redirect you to the hosted page, allowing you to delve into and fully explore my design and development skills. I specialize in React JavaScript, particularly in React Three Fiber and the creation of 3D-based websites.",
      length: 6,
      header: ["Published Websites + Client Designs", "MetaTunes", "K & M Renovation and Restoration", "Get Relocate", "Web³ Outfitters", "Feracho Brand"],
      text: [
        "Explore my portfolio by using the buttons below the floating monitor to navigate through previews of websites I have developed independently over recent years. Clicking on the screen will direct you to the hosted page, allowing for an in-depth exploration of my design and development expertise. My specialization lies in React JavaScript, with a focus on React Three Fiber and crafting 3D-based web experiences.",
        "This site was my first venture into web development from scratch, created for a now-defunct NFT project. It leverages React, JavaScript, and styled-components to deliver a seamless digital experience.",
        "For my second project, I developed a straightforward two-page website for an independent roofing contractor in Tennessee, utilizing Firebase's cloud services for deployment.",
        "I designed and developed a comprehensive website for a startup moving company named Relocate, aimed at competing with BellHops. The project integrated advanced technology within its framework to enhance operational efficiency, although it ultimately did not succeed.",
        "This project features a unique and specialized 3D ecommerce platform designed for an emerging food product. It incorporates technologies such as React Three Fiber, styled-components, framer motion, and react-spring to create an immersive online shopping experience.",
        ...
        "I developed a professional networking platform tailored for minorities, reminiscent of LinkedIn but with customized features. The site includes multiple pages and layouts, catering to a variety of profile types.",
        "This website serves as a digital gateway for a client’s hospitality and homing service, designed to offer a comprehensive and welcoming experience for users seeking accommodation and related services."
      ],      
      websiteUrls: [
        "https://metatunes.com/",
        "https://kandmrenovation.com",
        "https://main.d1kac4geol6jy1.amplifyapp.com",
        "https://www.sunnyislandpeppersauce.com/",
