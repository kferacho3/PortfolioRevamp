    ...
    <group position={[2, 0, 0]} ref={group} {...props} dispose={null}>
      ...
      >
        ...
        >
          ...
          >
            <group scale={index === 0 ? [0, 0, 0] : [1, 1, 1]} className="button-monitor" name="Left Button" ref={leftButton}>
          ...
          >
            <group scale={index === 0 ? [0, 0, 0] : [1, 1, 1]} ref={rightButton} className="button-monitor" name="Right Button">
