...
export default function Monitor({
  ...
  const applyHoverEffect = (object, elapsedTime) => {
    if (!object) return; // Add check to ensure object is defined
    const hoverValue = Math.sin(elapsedTime * hoverFrequency) * hoverAmplitude;
    object.position.y = hoverValue;
  };

  useFrame(({ clock }) => {
    const elapsedTime = clock.getElapsedTime();

    applyHoverEffect(leftButton.current, elapsedTime / 3);
    applyHoverEffect(rightButton.current, elapsedTime / 5);
    applyHoverEffect(monitor.current, elapsedTime);
  });
    ...
    <group name="Scene">
      <group name="Monitor" rotation={[Math.PI / 2, 0, 0]}>
        ...
        <mesh
          ...
          castShadow
          receiveShadow
          geometry={nodes.Monitor_10.geometry}
          material={materials['Material.012']}
        />
        <mesh
          name="Monitor_11"
          castShadow
          receiveShadow
          geometry={nodes.Monitor_11.geometry}
        ...
        <mesh
          ...
          castShadow
          receiveShadow
          geometry={nodes.Monitor_12.geometry}
          material={materials['Material.012']}
        />
        <mesh
          name="Monitor_13"
          castShadow
          receiveShadow
          geometry={nodes.Monitor_13.geometry}
        >
      ...
      <group name="Object_9" scale={0.02}>
          <skinnedMesh
        ...
        <group name="Object_9001" position={[1.081, 0.015, -0.39]} scale={0.02}>
          <skinnedMesh
